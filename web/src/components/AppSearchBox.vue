...
const hasResults = computed(
  () =>
    ...
    matchingCategories.value.length > 0 ||
    matchingBrands.value.length > 0,
);
...
<template>
  <div ref="containerRef" class="relative w-full">
    <form
      class="flex items-center gap-2 rounded-full border border-gray-300 px-3 py-1.5 dark:border-gray-700"
    ...
    >
      ...
      <p
        v-else-if="!loading"
        class="px-2 py-4 text-center text-sm text-gray-400 dark:text-gray-500"
      >
